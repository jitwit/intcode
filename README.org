...
#+name: intcode
#+begin_src scheme :session :noweb yes :exports none
...
#+begin_src scheme :session :tangle chez/intcode.sls :noweb yes :exports none
(library (intcode)
  (export ; export-list
          <<exports>>)
  (import (chezscheme))
...
#+begin_src scheme :session :tangle guile/intcode.scm :noweb yes :exports none
#!r6rs
(library (intcode)
  (export ; export-list
          <<exports>>)
